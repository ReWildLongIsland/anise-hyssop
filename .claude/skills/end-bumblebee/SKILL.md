---
name: end-bumblebee
description: End a work session on Bumblebee. Updates PLAN.md to reflect progress, commits everything, and pushes to GitHub so the other machine can pick up cleanly.
---
...
4. **Commit** with a clear message summarising what was built (not just "updates"):
